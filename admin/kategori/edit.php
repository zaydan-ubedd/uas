...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update->bind_param("ssi", $name, $description, $id);
    $update->execute();
...
<head>
    ...
    <title>Edit Kategori - AlyNews</title>
    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="POST">
                ...
                <textarea id="description" name="description" placeholder="Masukkan deskripsi kategori..."><?= htmlspecialchars($data['description']) ?></textarea>
